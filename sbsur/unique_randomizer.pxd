...
cdef void ur_free(ur_node_t* node) nogil
# Free the specified node and all of its children
cdef void ur_free_all(ur_node_t* node) nogil
...
cdef void ur_expand_node(ur_node_t *parent, double *log_probs, int categories, int child_index) nogil
# Add a new terminal child
cdef void ur_add_terminal_node(ur_node_t *parent, int child_index) nogil
# Simple getter
...
cdef void ur_get_possibles(ur_node_t* node, bool* out) nogil
